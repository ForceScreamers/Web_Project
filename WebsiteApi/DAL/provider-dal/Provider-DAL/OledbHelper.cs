...
namespace DAL
{
    public class oledbhelper
    {
        ...
        public static string ConnectionString
        {
            get
            {
                return @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + Application.StartupPath + "/Providers_Db.accdb";
        ...
        public static int Execute(string com, OleDbParameter[] queryParameters)
        {
            int result = 0;
